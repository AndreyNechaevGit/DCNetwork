...
- [IS-IS Underlay в сети CLOS](#is-is-underlay-в-сети-clos)
  - [2. Базовые настройки IS-IS для Cisco Nexus v9500.](#2-базовые-настройки-is-is-для-cisco-nexus-v9500)
  - [3. Проверка работы IS-IS](#3-проверка-работы-is-is)
...
##  2. Базовые настройки IS-IS для Cisco Nexus v9500.
...
**2.1 Включим протокол IS-IS и выполним базовую настройку**
...
**2.4 После проверки, что все работатет, дополнительно настроим авторизацию:**
